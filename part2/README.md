...
Open your application in two browsers. **If you delete a person in browser 1** a short while before attempting to *change the person's phone number* in browser 2, you will get an error message.
